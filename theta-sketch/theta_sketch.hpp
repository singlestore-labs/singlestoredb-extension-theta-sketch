...
class base_theta_sketch_alloc : public theta_data {
public:

  base_theta_sketch_alloc()
      : theta_data()
  {
  }
...
public:
  ...
  void update_by_hash(const uint64_t hash);
...
public:
  ...
  bool serialize2(unsigned char** bytes, size_t* size) const;
