...
int32_t __wasm_export_extension_sketch_update(int32_t arg, int32_t arg0) {
  extension_state_t ret = extension_sketch_update(arg, arg0);
  return ret;
}
__attribute__((export_name("sketch-union")))
int32_t __wasm_export_extension_sketch_union(int32_t arg, int32_t arg0) {
  extension_state_t ret = extension_sketch_union(arg, arg0);
  return ret;
}
__attribute__((export_name("sketch-intersect")))
int32_t __wasm_export_extension_sketch_intersect(int32_t arg, int32_t arg0) {
  extension_state_t ret = extension_sketch_intersect(arg, arg0);
  return ret;
}
__attribute__((export_name("sketch-anotb")))
int32_t __wasm_export_extension_sketch_anotb(int32_t arg, int32_t arg0) {
  extension_state_t ret = extension_sketch_anotb(arg, arg0);
  return ret;
}
__attribute__((export_name("sketch-serialize")))
int32_t __wasm_export_extension_sketch_serialize(int32_t arg) {
...
__attribute__((export_name("sketch-deserialize")))
int32_t __wasm_export_extension_sketch_deserialize(int32_t arg, int32_t arg0) {
...
__attribute__((export_name("sketch-destroy")))
int32_t __wasm_export_extension_sketch_destroy(int32_t arg) {
